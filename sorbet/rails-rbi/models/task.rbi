...
# Please rerun bundle exec rake rails_rbi:models[Task] to regenerate.

# typed: strong
module Task::ActiveRelation_WhereNot
...
module Task::CustomFinderMethods
...
class Task < ApplicationRecord
  ...
  extend Task::CustomFinderMethods
  extend Task::QueryMethodsReturningRelation
  RelationType = T.type_alias { T.any(Task::ActiveRecord_Relation, Task::ActiveRecord_Associations_CollectionProxy, Task::ActiveRecord_AssociationRelation) }
end

module Task::QueryMethodsReturningRelation
  ...
  sig { params(args: Symbol).returns(Task::ActiveRecord_Relation) }
  ...
  sig do
    params(
      ...
      block: T.nilable(T.proc.params(e: Task::ActiveRecord_Relation).void)
    ).returns(ActiveRecord::Batches::BatchEnumerator)
  end
  def in_batches(of: 1000, start: nil, finish: nil, load: false, error_on_ignore: nil, &block); end
end

module Task::QueryMethodsReturningAssociationRelation
  sig { returns(Task::ActiveRecord_AssociationRelation) }
  def all; end
  ...
  sig { params(args: Symbol).returns(Task::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end
  ...
  sig do
    params(
      ...
      load: T.nilable(T::Boolean),
      error_on_ignore: T.nilable(T::Boolean),
      block: T.nilable(T.proc.params(e: Task::ActiveRecord_AssociationRelation).void)
    ).returns(ActiveRecord::Batches::BatchEnumerator)
  end
  def in_batches(of: 1000, start: nil, finish: nil, load: false, error_on_ignore: nil, &block); end
end
...
class Task::ActiveRecord_Relation < ActiveRecord::Relation
  include Task::ActiveRelation_WhereNot
  include Task::CustomFinderMethods
  include Task::QueryMethodsReturningRelation
  Elem = type_member(fixed: Task)
end

class Task::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  include Task::ActiveRelation_WhereNot
  include Task::CustomFinderMethods
  include Task::QueryMethodsReturningAssociationRelation
  Elem = type_member(fixed: Task)
end
...
class Task::ActiveRecord_Associations_CollectionProxy < ActiveRecord::Associations::CollectionProxy
  ...
  sig { params(records: T.any(Task, T::Array[Task])).returns(T.self_type) }
  def <<(*records); end
