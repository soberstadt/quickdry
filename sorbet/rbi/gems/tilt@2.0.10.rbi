...
class Tilt::SassTemplate < ::Tilt::Template
  # @return [Boolean]
  #
  # source://tilt//lib/tilt/sass.rb#31
  def allows_script?; end

  # source://tilt//lib/tilt/sass.rb#27
  def evaluate(scope, locals, &block); end

  # source://tilt//lib/tilt/sass.rb#23
  def prepare; end
...
# source://tilt//lib/tilt/sass.rb#13
Tilt::SassTemplate::Sass = SassC

# Sass's new .scss type template implementation.
#
# source://tilt//lib/tilt/sass.rb#42
class Tilt::ScssTemplate < ::Tilt::SassTemplate
  private

  # source://tilt//lib/tilt/sass.rb#46
  def sass_options; end
end
