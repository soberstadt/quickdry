...
class Task
  ...
  module CommonRelationMethods
    ...
    sig do
      ...
      ).returns(T.nilable(T::Enumerator[::Task]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Task]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Task]]))
    end
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T::Boolean) }
    def completed_at_previously_changed?; end
    ...
    sig { returns(T::Boolean) }
    def completed_previously_changed?; end
